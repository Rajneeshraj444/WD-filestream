...
const BOT_TOKEN = "8354770467:AAGQ6xx5KKdl31_Jfn-fi24QAwja_Ad0YM8"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "BOT_SECRET"; // Insert a powerful secret text.
const BOT_OWNER = 5915871770; // Insert your telegram account id.
const BOT_CHANNEL = -1002941291275; // Insert your telegram channel id which the bot is admin in.
